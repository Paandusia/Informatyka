    ...
    case 1: 
        ...
        for(int a=0; a<7; a++){ 
            if (ksiazki[a].rok >= wrok){ 
                cout << ksiazki[a].tytul << "   " << ksiazki[a].autor << "   " << ksiazki[a].rok << "   " << ksiazki[a].wydawnictwo << "   " << ksiazki[a].cena << "   " << endl; 
            } 
        } 
    break; 
    ...
    case 2: 
        ...
        for(int a=0;a<7;a++){ 
            if (ksiazki[a].cena >= wcena){ 
                cout << ksiazki[a].tytul << "   " << endl; 
                cout << ksiazki[a].autor << "   " << endl; 
                cout << ksiazki[a].rok << "   " << endl; 
                cout << ksiazki[a].wydawnictwo << "   " << endl; 
